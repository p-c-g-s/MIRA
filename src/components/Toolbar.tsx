...
export function Toolbar() {
  ...
  return (
    ...
    >
      ...
      {/* About */}
      <Btn onClick={handleAbout} title="About Mira"><InfoIcon /></Btn>
...
function InfoIcon()  { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="9"/><line x1="12" y1="10" x2="12" y2="16"/><circle cx="12" cy="7" r="1"/></svg>; }
